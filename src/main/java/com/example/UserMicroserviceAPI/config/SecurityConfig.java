...
public JdbcUserDetailsManager userDetailsManager(DataSource dataSource) {
    ...
    // String authoritiesByUsernameQuery = "SELECT username, authority FROM authority WHERE username = ?";
    String authoritiesByUsernameQuery = "SELECT u.username, a.authority FROM user u " +
